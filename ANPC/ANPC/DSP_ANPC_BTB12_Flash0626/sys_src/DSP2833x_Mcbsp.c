...
//   McbspaRegs.SPCR2.all=0x02c1; // *XRST =0	//zq
//   McbspaRegs.SPCR1.all=0x2000; //0X8000 *RRST =0, DLB enabled	//zq
   //McbspaRegs.RCR2.all =0x00a0;	//0x1321;	*//zq
   McbspaRegs.RCR2.all =0x0000;	//0x1321;	*//zq
   McbspaRegs.RCR1.all =0x00a0;		// *
   //McbspaRegs.XCR2.all=0x00a0;	//0X1321*//zq
   McbspaRegs.XCR2.all=0x0000;	//0X1321*//zq
   McbspaRegs.XCR1.all=0x00a0;		//*
    
   //McbspaRegs.SRGR2.all=0x3f;	//*0x3140;	//*//zq
   //McbspaRegs.SRGR1.all=0x1f00;	//0x010f;	//*//zq
   //McbspaRegs.MCR2.all=0x0;		//*zq
   //McbspaRegs.MCR1.all=0x0;		//*//zq
   //McbspaRegs.PCR.all=0X008f;	//0x00a00;	//*//zq
   McbspaRegs.PCR.all=0x0002;	//0x00a00;	//*//zq
