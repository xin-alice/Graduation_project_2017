...
void InitSysCtrl(void)
{
   ...
   InitPll(DSP28_PLLCR,DSP28_DIVSEL);///10,2
...
// HISPCP/LOSPCP prescale register settings, normally it will be set to default values
  // SysCtrlRegs.HISPCP.all = 0x0001;  //sysclockout/2
   SysCtrlRegs.HISPCP.all = 0x0000;  //sysclockout/1
   SysCtrlRegs.LOSPCP.all = 0x0002;  //sysclockout/4
